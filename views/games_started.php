...
$(document).ready(function(){
   ...
   function refreshTable(){
        ...
        $('#content').load("http://appserver-01.alunos.di.fc.ul.pt/~asw014/Admin/game_started #content", function(){
        	$('#tabela').dataTable();
        ...
        array_unshift($games, array("ID","STARTED_AT","ENDED_AT","DECK","TABLE_CARDS","GAME_STATE","CURRENT_PLAYER","CURRENT_BET","CURRENT_POT","PLAYER_ON_BUTTON","LAST_TO_RAISE","WINNER", "Timer"));
